...
import { 
  ...
  CreditCard, Loader2, Settings, Menu, X, FileText, ListPlus, Building2, LifeBuoy
} from "lucide-react";
    ...
    <div className="flex flex-col md:flex-row h-screen bg-transparent relative overflow-hidden">
        ...
        <div className="fixed inset-0 z-50 flex md:hidden">
          ...
          <div className="relative w-72 max-w-[80%] bg-white/95 backdrop-blur-xl h-full shadow-2xl flex flex-col animate-in slide-in-from-left duration-200">
            ...
            <nav className="flex-1 p-4 space-y-2 overflow-y-auto">
              ...
              <Link href="/dashboard/company-admin/support" onClick={() => setIsMobileMenuOpen(false)} className={`flex items-center gap-3 px-3 py-3 rounded-md transition-colors font-medium text-sm ${pathname === "/dashboard/company-admin/support" ? "text-blue-700 bg-blue-50" : "text-zinc-600 hover:bg-zinc-100/50"}`}><LifeBuoy size={20} /> Help Desk</Link>
      ...
      <aside className="w-64 bg-white/80 backdrop-blur-md border-r border-zinc-200/60 hidden md:flex flex-col shadow-sm z-20 h-full shrink-0">
        ...
        <nav className="flex-1 p-4 space-y-2 overflow-y-auto">
          ...
          <Link href="/dashboard/company-admin/support" className={`flex items-center gap-3 px-3 py-2.5 rounded-md transition-colors font-medium text-sm ${pathname === "/dashboard/company-admin/support" ? "text-blue-700 bg-blue-50/80 shadow-sm" : "text-zinc-600 hover:bg-zinc-100/50"}`}><LifeBuoy size={18} /> Help Desk</Link>
