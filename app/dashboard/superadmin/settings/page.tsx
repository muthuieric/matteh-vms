  ...
  return (
    <div className="p-6 md:p-10 max-w-4xl mx-auto space-y-8">
      <div className="border-b border-zinc-200 pb-4">
        ...
        <p className="text-zinc-500 mt-1">Manage your Superadmin profile and security credentials.</p>
      </div>
        ...
        <Card className="md:col-span-2 shadow-sm border-t-4 border-t-amber-500">
          ...
          <CardContent>
            <form onSubmit={handleUpdatePassword} className="space-y-4">
              ...
              <Button type="submit" disabled={loading} className="mt-4 bg-zinc-900 hover:bg-zinc-800 text-white">
